						...
						<div class="col-lg-6 col-md-8 no-pd pt-2">
							...
							<script>
								function searchEvents(event) {
									...
									const url = `search_events1.php?query=${encodeURIComponent(searchQuery)}`;
							...
							<div class="post-topbar">
											<div class="user-picy">
											<img style="border-radius:50%; width:50px; height:50px" src="<?php echo $user_info['picture'] ?>" alt="User Profile Picture">
											</div>
											<div class="post-st">
												<ul>
...
$user_id_query = "SELECT id FROM users WHERE name = '" . $_SESSION['organizer_name'] . "'";
...
function fetchPostbar(eventId) {
    ...
    const url = `fetch_postbar1.php?event_id=${eventId}`;
    xhr.open("GET", url, true);
    xhr.send();
}
