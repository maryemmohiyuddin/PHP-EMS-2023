...
<head>
	<meta charset="UTF-8">
	<title>Oragnizer Dashboard</title>
    ...
    function searchEvents(event) {
        ...
        xhr.send();
					...
					<nav>
						<ul>
							<li>
								<a href="organizerdashboard.php" title="" target="_top">
							...
							<li>
								<a href="orgprofile.php" title="" target="_top">
...
?>  <div  style=""  class="user1-list">
  
</div> <script src="javascript/user1.js"></script>
