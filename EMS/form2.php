...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>setTimeout(function(){ window.location = 'getstarted.php'; }, 3000);</script>"; // Redirect after 3 seconds
        exit();
    }
    ...
    if ($stmtInsert->execute()) {
        $_SESSION["organizer_name"] = $usrname;
        $_SESSION["organizer_email"] = $email;
        $_SESSION["organizer_gender"] = $gender;
        $_SESSION["organizer_city"] = $city;
        $_SESSION["organizer_type"] = $type;
